namespace AutoFixture.NUnit3
{
    ...
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="AutoFixture.NUnit3.ModestAttribute" />)
    ///     and namespace <see cref="AutoFixture.NUnit3"/> class using generator(v:0.2.4.1)'s
    ///     artificial intelligence. Compatible with <see cref="AUT.TestProjects.GenerationVersion2" /> v1.5.2+.
    /// </summary>
    [TestFixture]
    [ExcludeFromCodeCoverage]
    public class ModestAttributeTest : AbstractBaseSetupV2Test
    {
        /// <summary>
        ///     Automatic Unit Tests for a public class (<see cref="ModestAttribute" />)
        /// </summary>
        public ModestAttributeTest() : base(typeof(ModestAttribute))
        {}
        ...
        #region General Initializer : Class (ModestAttribute) Initializer

        #region General Initializer : Class (ModestAttribute) One time setup

        private Type _modestAttributeInstanceType;
        private ModestAttribute _modestAttributeInstance;
        private ModestAttribute _modestAttributeInstanceFixture;
        private const int TestsTimeOut = TestContants.TimeOutEightSeconds;

        /// <summary>
        ///    Setting up everything for <see cref="ModestAttribute" /> one time.
        /// </summary>
        [OneTimeSetUp]
        [ExcludeFromCodeCoverage]
        ...
        #region General Initializer : Class (ModestAttribute) Explore Non-listed Methods

        /// <summary>
        ///     Class (<see cref="ModestAttribute" />) explore and verify methods for coverage gain which is not listed in the constants.
        /// </summary>
        [Test]
        [Timeout(TestContants.TimeOutFortySeconds)]
        [Category("AUT Reflection NonListed")]
        [Category("AUT Slow Tests")]
        public void AUT_ModestAttribute_Explore_Reflection_Based_NonListed_Methods_Test()
        {
            // Assert
        ...
        #region Explore Class for Coverage Gain : Class (ModestAttribute)

        #region General Initializer : Class (ModestAttribute) All Methods Explore Verification.

        /// <summary>
        ///     Class (<see cref="ModestAttribute" />) explore and verify fields for coverage gain.
        /// </summary>
        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT Initializer")]
        [TestCase(MethodGetCustomization, 0)]
        public void AUT_ModestAttribute_All_Methods_Explore_Verify_Test(string name, int overloadingIndex = 0)
        {
            // Arrange
        ...
        #region General Instance : Class (ModestAttribute) Static Class or Instance Creation

        /// <summary>
        ///     Class (<see cref="ModestAttribute" />) can be created test
        /// </summary>
        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT Instance")]
        public void AUT_ModestAttribute_Is_Instance_Present_Test()
        {
            // Assert
            _modestAttributeInstanceType.ShouldNotBeNull();
            _modestAttributeInstance.ShouldNotBeNull();
            _modestAttributeInstanceFixture.ShouldNotBeNull();
            CurrentInstance.ShouldNotBeNull();
        }

        #endregion

        #region General Instance : Class (ModestAttribute) Instance Type Verify Test

        /// <summary>
        ///     Class (<see cref="ModestAttribute" />) instance type verify test.
        /// </summary>
        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT Instance")]
        public void AUT_ModestAttribute_Is_Instance_Type_Verify_Test()
        {
            // Assert
            _modestAttributeInstance.ShouldBeAssignableTo<ModestAttribute>();
            _modestAttributeInstanceFixture.ShouldBeAssignableTo<ModestAttribute>();
            CurrentInstance.ShouldBeAssignableTo<ModestAttribute>();
        }
        ...
        #region General Constructor : Class (ModestAttribute) without Parameter Test
        ...
        [ExcludeFromCodeCoverage]
        private void AUT_ModestAttribute_GetCustomization_Method_Call_Internally(Type[] types)
        {
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_ModestAttribute_GetCustomization_Method_Call_With_No_Parameters_Call_Results_ShouldBe_Null_If_Not_Premitive_Type_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodGetCustomization);
            var parameter = this.CreateType<ParameterInfo>();
            ...
            // Act
            var result1 = methodInfo.GetResultMethodInfo<ICustomization>(_modestAttributeInstanceFixture, parametersOfGetCustomization);
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_ModestAttribute_GetCustomization_Method_Call_With_Call_No_Exception_Thrown_With_Encapsulation_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodGetCustomization);
            var parameter = this.CreateType<ParameterInfo>();
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_ModestAttribute_GetCustomization_Method_Call_Dynamic_Invoking_Results_Null_If_Not_Primitive_Type_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodGetCustomization);
            var methodGetCustomizationParametersTypes = new Type[] { typeof(ParameterInfo) };
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_ModestAttribute_GetCustomization_Method_Call_Dynamic_Invoking_Should_Not_Throw_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodGetCustomization);
            var methodGetCustomizationParametersTypes = new Type[] { typeof(ParameterInfo) };
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_ModestAttribute_GetCustomization_Method_Call_Dynamic_Invoking_Results_Should_Be_Null_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodGetCustomization);
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_ModestAttribute_GetCustomization_Method_Call_Parameters_Count_Verification_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodGetCustomization);
            var methodInfo = this.GetMethodInfo(MethodGetCustomization, 0);
